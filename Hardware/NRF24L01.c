...
/*全局变量*********************/
NRF24L01_Config_t NRF24L01_Config = 
{
	.CE_GPIOx = GPIOA,
	.CE_GPIO_Pin = GPIO_Pin_8,
	
	.CSN_GPIOx = GPIOA,
	.CSN_GPIO_Pin = GPIO_Pin_15,
	
	.SCK_GPIOx = GPIOB,
	.SCK_GPIO_Pin = GPIO_Pin_3,
	
	.MISO_GPIOx = GPIOB,
	.MISO_GPIO_Pin = GPIO_Pin_4,
	
	.MOSI_GPIOx = GPIOB,
	.MOSI_GPIO_Pin = GPIO_Pin_5
};
...
void NRF24L01_W_CE(uint8_t BitValue)
{
	...
	GPIO_WriteBit(NRF24L01_Config.CE_GPIOx, NRF24L01_Config.CE_GPIO_Pin, (BitAction)BitValue);
}
...
void NRF24L01_W_CSN(uint8_t BitValue)
{
	...
	GPIO_WriteBit(NRF24L01_Config.CSN_GPIOx, NRF24L01_Config.CSN_GPIO_Pin, (BitAction)BitValue);
}
...
void NRF24L01_W_SCK(uint8_t BitValue)
{
	...
	GPIO_WriteBit(NRF24L01_Config.SCK_GPIOx, NRF24L01_Config.SCK_GPIO_Pin, (BitAction)BitValue);
}
...
void NRF24L01_W_MOSI(uint8_t BitValue)
{
	...
	GPIO_WriteBit(NRF24L01_Config.MOSI_GPIOx, NRF24L01_Config.MOSI_GPIO_Pin, (BitAction)BitValue);
}
...
{
	/*取MISO引脚的高低电平并返回*/
	return GPIO_ReadInputDataBit(NRF24L01_Config.MISO_GPIOx, NRF24L01_Config.MISO_GPIO_Pin);
}
...
void NRF24L01_GPIO_Init(void)
{
	...
	GPIO_PinRemapConfig(GPIO_Remap_SWJ_JTAGDisable, ENABLE);	//禁用JTAG，释放PB3、PB4、PB5引脚
	...
	GPIO_InitStructure.GPIO_Pin = NRF24L01_Config.CE_GPIO_Pin;
	GPIO_Init(NRF24L01_Config.CE_GPIOx, &GPIO_InitStructure);
	GPIO_InitStructure.GPIO_Pin = NRF24L01_Config.CSN_GPIO_Pin;
	GPIO_Init(NRF24L01_Config.CSN_GPIOx, &GPIO_InitStructure);
	GPIO_InitStructure.GPIO_Pin = NRF24L01_Config.SCK_GPIO_Pin;
	GPIO_Init(NRF24L01_Config.SCK_GPIOx, &GPIO_InitStructure);
	GPIO_InitStructure.GPIO_Pin = NRF24L01_Config.MOSI_GPIO_Pin;
	GPIO_Init(NRF24L01_Config.MOSI_GPIOx, &GPIO_InitStructure);
	
	
	/*将MISO引脚初始化为上拉输入模式*/
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_InitStructure.GPIO_Pin = NRF24L01_Config.MISO_GPIO_Pin;
	GPIO_Init(NRF24L01_Config.MISO_GPIOx, &GPIO_InitStructure);
